...
//  jQuery('head').append('<link rel="stylesheet" href="/sites/all/modules/custom/bottom/imx_bottom_v5.css"/>');
...
function buildFeedItems(parent, feed) {
    ...
    item_html += '<div class="bottom-links-footer"><a class="gotop" href="#">Ir arriba</a><a class="politica-ambiental" href="#">PolÃ­tica ambiental</a><a class="mapa-sitio" href="#">Mapa de sitio</a><a class="feed-rss" href="#">RSS</a></div>';
    item_html += '</div>';
                            ...
                            <div class="bottom-top prelative">\n\
                                <div class="bottom-top-links-wrapper">\n\
                                    ...
                                    <div class="bottom-top-links">\n\
                                        <a class="terminos-condiciones" href="#">TÃ©rminos y condiciones de uso</a>\n\
                                        <a class="politicas-privacidad" href="#">Aviso de privacidad</a>\n\
                                        <div class="bottom-trigger tacenter">\n\
                                            <span class="trigger">\n\
                                               <span class="trigger-text">Ver red Inventmx</span>\n\
                                ...
                                <span class="copy clear tacenter dblock">Â© 2014 InventMX. Todos los derechos reservados. Prohibida la reproducciÃ³n total o parcial, incluyendo cualquier medio electrÃ³nico o magnÃ©tico.</span>\n\
                            </div>\n\
...
//                console.log(VarScroll);
        ...
        jQuery("#bottom-imx-fixed .trigger").click(function(){
            if(jQuery(this).find('#trigger-icon').hasClass('arrow-up')){
                ...
                jQuery(this).find('.trigger-text').html('Ocultar red Inventmx');
                ...
                jQuery(this).find('.trigger-text').html('Ver red Inventmx');
                    jQuery("#bottom-imx-fixed .bottom-links").animate({
                        height: "1px"
                    }, 1000);
            }
