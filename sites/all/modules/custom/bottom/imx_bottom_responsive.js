...
jQuery(document).ready(function () {//Creeamos los tags script para las dependencias a utilizar
    jQuery('head').append('<link rel="stylesheet" href="http://776561ea720ed80d100a-d15d7e8f8f7f4ad15567639aa98ea820.r76.cf2.rackcdn.com/imx_bottom_responsive.css"/>');
//    jQuery('head').append('<link rel="stylesheet" href="/sites/all/modules/custom/bottom/imx_bottom_responsive.css"/>');
    
    //Carga del jCarruselListe
    jQuery('head').append('<script type="text/javascript" src="http://776561ea720ed80d100a-d15d7e8f8f7f4ad15567639aa98ea820.r76.cf2.rackcdn.com/jquery.jcarousel.min.js"></script>');
//    jQuery('head').append('<script type="text/javascript" src="/sites/all/modules/custom/bottom/jquery.jcarousel.min.js"></script>');
...
function buildFeedItems(parent, feed) {
    ...
    if (jQuery("#bottom-links #excelsiorDir").length > 0) {
        item_html += '<div class="bottom-links-footer"><p class="copy clear tacenter dblock">&copy; '+currentYear+' InventMX. Todos los derechos reservados. Prohibida la reproducción total o parcial, incluyendo cualquier medio electrónico o magnético.</p><a class="politica-ambiental" href="#">Política ambiental</a><a class="mapa-sitio" href="#">Mapa de sitio</a><a class="excDir" href="#">Directorio</a><a class="excSusc" href="#">Suscripción</a><a class="feed-rss" href="#">RSS</a></div>';
    } else {
        item_html += '<div class="bottom-links-footer"><p class="copy clear tacenter dblock">&copy; '+currentYear+' InventMX. Todos los derechos reservados. Prohibida la reproducción total o parcial, incluyendo cualquier medio electrónico o magnético.</p><a class="politica-ambiental" href="#">Política ambiental</a><a class="mapa-sitio" href="#">Mapa de sitio</a><a class="feed-rss" href="#">RSS</a></div>';
    }
    item_html += '</div>';
...
//                console.log(VarScroll);
        ...
        if (typeof jQuery().jcarousel !== "undefined") {
            var jcarousel = jQuery("#bottom-imx-fixed .bottom-links-notes");
            ...
            jQuery('.bottom-links-prev').jcarouselControl({
                target: '-=1'
            });

            jQuery('.bottom-links-next').jcarouselControl({
                target: '+=1'
            });
        }
