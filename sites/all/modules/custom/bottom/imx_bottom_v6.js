...
jQuery(document).ready(function () {//Creeamos los tags script para las dependencias a utilizar
    if (jQuery("#imx_bottom_js").hasClass('imx_bottom_light')) {
    //    jQuery('head').append('<link rel="stylesheet" href="http://776561ea720ed80d100a-d15d7e8f8f7f4ad15567639aa98ea820.r76.cf2.rackcdn.com/imx_bottom_v6_2015.css"/>');
        jQuery('head').append('<link rel="stylesheet" href="/sites/all/modules/custom/bottom/imx_bottom_v6_2015.css"/>');
    } else {
        jQuery('head').append('<link rel="stylesheet" href="http://776561ea720ed80d100a-d15d7e8f8f7f4ad15567639aa98ea820.r76.cf2.rackcdn.com/imx_bottom_v5_2015.css"/>');
    }
    
    //Carga del jCarruselListe
    jQuery('head').append('<script type="text/javascript" src="http://776561ea720ed80d100a-d15d7e8f8f7f4ad15567639aa98ea820.r76.cf2.rackcdn.com/jCarouselLite.js"></script>');

    loadBottom("bottom_feeds");

    /*
     //Bloqueos para usuarios anonimos
     ...
     jQuery("html,body").css("-webkit-user-select","none");
     jQuery("html,body").css("-moz-user-select","none");
     jQuery("html,body").css("-khtml-user-select","none");
     jQuery("html,body").css("-ms-user-select","none");
     }
     */
});
...
function buildFeedItems(parent, feed) {
        ...
        if (typeof a !== "undefined") {
            ...
            jQuery.each(this, function (i) {
                ...
                if (i == 0) {
                    ...
                    title = truncate_text(this.title, 120, "");
                    item_html += '<li>';
    ...
    if (jQuery("#bottom-links #excelsiorDir").length > 0) {
        item_html += '<div class="bottom-links-footer"><a class="politica-ambiental" href="#">Política ambiental</a><a class="mapa-sitio" href="#">Mapa de sitio</a><a class="excDir" href="#">Directorio</a><a class="excSusc" href="#">Suscripción</a><a class="feed-rss" href="#">RSS</a></div>';
    } else {
        item_html += '<div class="bottom-links-footer"><a class="politica-ambiental" href="#">Política ambiental</a><a class="mapa-sitio" href="#">Mapa de sitio</a><a class="feed-rss" href="#">RSS</a></div>';
    }
    item_html += '</div>';
...
function renderButtom(feedData) {
                            ...
                            <div class="bottom-top prelative" style="width:'+width+'px;">\n\
                                <div class="bottom-top-links-wrapper">\n\
                                    ...
                                    <div class="bottom-top-links">\n\
                                        ...
                                        <a class="politica-ambiental" href="#">Política ambiental</a>\n\
                                ...
                                <div class="bottom-top prelative">\n\
                                    <div class="bottom-top-links-wrapper">\n\
                                        ...
                                        <div class="bottom-top-links">\n\
                                            <a class="terminos-condiciones" href="#">Términos y condiciones de uso</a>\n\
                                            <a class="politicas-privacidad" href="#">Aviso de privacidad</a>\n\
                                            <a class="gotop" href="#">Ir arriba</a>\n\
                                            <div class="bottom-trigger tacenter">\n\
                                                <span class="arrowCorner"></span>\n\
                                                <span class="trigger prelative">\n\
                                                   <span class="trigger-text">NUESTROS SITIOS</span>\n\
                                                   <span id="trigger-icon" class="arrow-up"></span>\n\
                                                   </span>\n\
                                            </div>\n\
                                            <div class="clear"></div>\n\
                                        </div>\n\
    ...
    if (jQuery("#imx_bottom_js").hasClass('imx_bottom_random_contents')) {
        if (typeof jQuery().shuffle !== "undefined") {
            jQuery(".bottom-links-notes ul").shuffle();
        }
    }

    if (jQuery("#imx_bottom_js").hasClass('imx_bottom_open')) {
        jQuery("#bottom-imx-fixed .trigger").click();
    }
    ...
    if (typeof jQuery().jCarouselLite == "undefined") {
        (function (e) {
            ...
            e.fn.jCarouselLite = function (t) {
                t = e.extend({btnPrev: null, btnNext: null, btnGo: null, mouseWheel: false, auto: null, speed: 200, easing: null, vertical: false, circular: true, visible: 3, start: 0, scroll: 1, beforeStart: null, tiempo: 8e3, afterEnd: null}, t || {});
                return this.each(function () {
                    function b() {
                    ...
                    if (t.btnGo)
                        e.each(t.btnGo, function (n, r) {
                            e(r).click(function () {
                                clearInterval(t.tiempo);
                                t.tiempo = setInterval(function () {
                                    w(v + t.scroll)
                                }, t.tiempo);
...
//                console.log(VarScroll);
        ...
        if (typeof jQuery().jCarouselLite !== "undefined") {
            jQuery("#bottom-imx-fixed .trigger").click(function () {
                if (jQuery(this).find('#trigger-icon').hasClass('arrow-up')) {
                    jQuery(this).find('#trigger-icon').removeClass('arrow-up').addClass('arrow-down');
                    jQuery(this).find('.trigger-text').html('CERRAR');
                    jQuery(this).css('margin-left',"45px");
                    ...
                    if (jQuery("#bottom-imx-fixed-wrapper.bottom-static").length > 0) {
                        ...
                        if (jQuery("#imx_bottom_js").hasClass('imx_bottom_open')) {
                            jQuery("#imx_bottom_js").removeClass('imx_bottom_open');
                        }
                    }
                } else {
                    jQuery(this).find('#trigger-icon').removeClass('arrow-down').addClass('arrow-up');
                    jQuery(this).find('.trigger-text').html('NUESTROS SITIOS');
...
function buildLinks() {
    ...
    rss = jQuery("#rss").html();
    eDir = jQuery("#bottom-links #excelsiorDir").length > 0 ? jQuery("#bottom-links #excelsiorDir").html() : false;
    eSus = jQuery("#bottom-links #excelsiorSusc").length > 0 ? jQuery("#bottom-links #excelsiorSusc").html() : false;
    ...
    if (eDir) {
        jQuery(".excDir").attr("href", eDir);
    }
    if (eSus) {
        jQuery(".excSusc").attr("href", eSus);
    }
}
